...
import ratatouillerestapp.upc.edu.pe.ui.custom.RoundedImageView;
...
public class MainActivity extends BaseActivity implements MainMvpView {
    ...
    public void showCustomerFragment() {
        ...
        getSupportFragmentManager()
                ...
                .disallowAddToBackStack()
                .setCustomAnimations(R.anim.slide_left, R.anim.slide_right)
                .add(R.id.cl_root_view, CustomerFragment.newInstance(), CustomerFragment.TAG)
                .commit();
    ...
    public void showProductFragment() {
        ...
        getSupportFragmentManager()
                ...
                .disallowAddToBackStack()
                .setCustomAnimations(R.anim.slide_left, R.anim.slide_right)
                .add(R.id.cl_root_view, ProductFragment.newInstance(), ProductFragment.TAG)
                .commit();
